...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //menampilkan gambar buat "php artisan storage:link" terlebih dahulu
    ...
    public function store(Request $request)
    {
        ...
        $new_user->roles = json_encode($request->get('role'));
    ...
    {
        //mengambil data user dan mengedit
    ...
    public function destroy($id)
    {
        ...
        $user = \App\User::findOrFail($id);
        $user->delete();
        return redirect()->route('users.index')->with('status', 'User Succesfull Deleted');
    }
}
