...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('categories.create')->with('status', 'Created Categories successfully created');
    }
    ...
    //untuk melihat list yang telah soft deletes
    ...
    //untuk merestore yang di soft deletes
    ...
    //untuk menghapus secara permanent
    ...
    {
        //fungsi mencari data dengan ajax
