...
class BookController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->get('save_action') == 'PUBLISH') {
            return redirect()->route('books.create')->with('status', 'Books Succesfully Save and Publish');
        } else {
            return redirect()->route('books.create')->with('status', 'Books Save As Draft');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($new_cover) {
            if ($book->cover && file_exists(storege_path('app/public' . $book->cover))) {
